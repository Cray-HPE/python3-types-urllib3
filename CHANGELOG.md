## 1.26.25.14.1 (2026-05-01)

First release of Cray/HPE fork.
Correct return type of `util.Retry.increment()` from `Retry` to `Self`

# Original history (from typeshed-era) follows

## 1.26.25.14 (2023-07-20)
